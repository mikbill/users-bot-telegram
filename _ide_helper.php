...
')
     ...
     * @method static True|PromiseInterface|False                       answerInlineQuery(array $parameters = [])                   Use this method to send answers to an inline query. On success, True is returned. No more than 50 results per query are allowed.
